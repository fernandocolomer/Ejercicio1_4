package com.joshua_mc.ejercicio1_4_2;
...
import com.joshua_mc.ejercicio1_4_2.config.SQLiteConexion;
import com.joshua_mc.ejercicio1_4_2.config.Transacciones;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void onClickListActivity(View view) {
        Intent lista = new Intent(getApplicationContext(), com.joshua_mc.ejercicio1_4_2.ActivityLista.class);
        startActivity(lista);
    }
    ...
    private void takePhoto() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                if (photoFile != null) {
                    Uri photoURI = FileProvider.getUriForFile(this, "com.joshua_mc.ejercicio1_4_2.fileprovider", photoFile);
